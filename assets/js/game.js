const storyQuestionElement = document.getElementById('story-question-text')
const optionButtonsElements = document.getElementById('options-buttons')

// counts how many lifes player have
const lifeCounter = {}
